...
<head>
    ...
    <meta charset="utf-8" />
    <title>Municipalidad de Quetzaltenango</title>
...
<body data-layout-mode="default" data-menu-position="fixed" data-leftbar-color="{{ $adminData->theme }}" data-theme="{{ $adminData->theme }}" data-topbar-color="{{ $adminData->theme }}" data-leftbar-size='default' data-sidebar-user='false'>

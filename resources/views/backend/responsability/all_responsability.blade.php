                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <a href="{{ route('add.item') }}" class="btn btn-success rounded-pill waves efect waves-light">{{ __('new-item') }}</a>
                        </ol>
                    </div>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td align="right">
                                        ...
                                        <a href="{{ route('item.delete', $item->id) }}" class="btn btn-danger rounded-pill waves-effect waves-light" id="delete">Eliminar </a>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>

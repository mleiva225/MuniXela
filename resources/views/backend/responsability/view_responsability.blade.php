                                ...
                                <div class="row"> <!-- init row -->
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="code" class="form-control @error('code') is-invalid @enderror" value="{{ $item->code }}" readonly>
                                            @error('code')
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" value="{{ $item->name }}" autocomplete="name" readonly>
                                            @error('name')
                                            <span class="text-danger"> {{ $message }} </span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" name="quantity" class="form-control @error('quantity') is-invalid @enderror" value="{{ $item->quantity }}" readonly>
                                            @error('quantity')
                                            <span class="text-danger"> {{ $message }} </span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="series" class="form-control @error('series') is-invalid @enderror" value="{{ $item->series }}" readonly>
                                            @error('series')
                                            <span class="text-danger"> {{ $message }} </span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="sicoin_gl" class="form-control @error('sicoin_gl') is-invalid @enderror" value="{{ $item->sicoin_gl }}" readonly>
                                            @error('sicoin_gl')
                                            <span class="text-danger"> {{ $message }} </span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="observations" class="form-control @error('observations') is-invalid @enderror" value="{{ $item->observations }}" readonly>
                                            @error('observations')
                                            <span class="text-danger"> {{ $message }} </span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <textarea type="text" name="description" class="form-control @error('description') is-invalid @enderror" value="{{ $item->description }}" readonly></textarea>
                                            @error('description')
                                            <span class="text-danger"> {{ $message }} </span>
                                            @enderror
                                        </div>

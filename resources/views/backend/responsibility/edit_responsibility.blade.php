                ...
                <div class="page-title-box">
                    ...
                    <ol class="breadcrumb m-0 page-title">
                        <li class="breadcrumb-item">
                            <a href="{{ route('all.responsibility') }}" class="btn btn-info rounded-pill waves efect waves-light">{!! $returnIcon !!}
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="tab-pane" id="settings">
                            <form method="post" action="{{ route('responsibility.update') }}" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="row"> <!-- init row -->
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="series" class="form-control @error('series') is-invalid @enderror" value="{{ $sheet->series }}">
                                            @error('series')
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label for="id_responsible" class="form-label">Usuario asignado*</label>
                                            <select name="id_responsible" class="form-control @error('id_responsible') is-invalid @enderror">
                                                @foreach ($users as $user)
                                                <option value="{{ $user->id }}" {{ $user->id == $sheet->id_responsible ? 'selected' : '' }}>

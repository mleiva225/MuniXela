                    ...
                    <ul class="nav nav-tabs" id="itemTab" role="tablist">
                        <li class="nav-item" role="presentation">
                            <button class="nav-link active" id="data-tab" data-bs-toggle="tab" data-bs-target="#data"
                                type="button" role="tab" aria-controls="data"
                                aria-selected="true">{{ __('general-data') }}</button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="qr-tab" data-bs-toggle="tab" data-bs-target="#qr" type="button"
                                role="tab" aria-controls="qr" aria-selected="false">{{ __('item-qr') }}</button>
                        </li>
                    </ul>
                    <!-- end tab header -->
                        ...
                        <div class="card-body">
                            ...
                            <div class="tab-content" id="itemTabContent">
                                        ...
                                        <form method="post" action="{{ route('item.update') }}"
                                            ...
                                            <div class="row mb-4"> <!-- init row -->
                                                <div class="col-md-3">
                                                    <div class="mb-3">
                                                        <label for="code"
                                                            class="form-label">{{ __('code') }}*</label>
                                                ...
                                                <div class="col-md-3">
                                                    <div class="mb-3">
                                                        <label for="unit_value"
                                                            class="form-label">{{ __('unit-value') }}</label>
                                                ...
                                                <div class="col-md-3">
                                                    <div class="mb-3">
                                                        <label for="series"
                                                            class="form-label">{{ __('series') }}</label>
                                                ...
                                                <div class="col-md-3">
                                                    <div class="mb-3">
                                                        <label for="sicoin_gl"
                                                            class="form-label">{{ __('sicoin-gl') }}</label>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        <label for="created_at"
                                                            class="form-label">{{ __('created-at') }}</label>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        <label for="updated_at"
                                                            class="form-label">{{ __('updated-at') }}</label>
                                ...
                                <div class="tab-pane fade" id="qr" role="tabpanel" aria-labelledby="qr-tab">
                                    ...
                                    <div class="row">
                                        <form method="get" action="{{ route('item.downloadqr', $item->id) }}"
                                            enctype="multipart/form-data">
                                            @csrf
                                            ...
                                            <div class="visible-print text-center">
                                                ...
                                                <span
                                                    class="h3 d-block">{{ __('view-item-:attribute', ['attribute' => $item->code]) }}
                                                </span>

                                                <div class="text-end">
                                                    <button type="submit"
                                                        class="btn btn-blue waves-effect waves-light mt-2">{!! $downloadIcon !!}
                                                        {{ __('download') }} </button>
                                                </div>
